...
begin
  ...
  if p_order_number < 1 then raise exception 'Order ID must be a positive whole number'; end if;
...
-- -----------------------------------------------------------------------------
-- Unrestricted Order Numbers & Sequence Synchronization (202609190003)
-- -----------------------------------------------------------------------------
